                      ...
                      <span className="flex items-center gap-2">
                        ...
                        {row.kind === "custom" ? (
                          <>
                            ...
                            {editable ? (
                              <button type="button" onClick={() => setEditing(row.record)} className="-my-2 inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-[#4A6373] hover:bg-slate-100 hover:text-[#1B303C] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1B303C]/30" aria-label={`Edit ${row.label}`}>
  ...
  if (editable) {
    ...
    return (
      <button
        ...
        className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-[#1B303C]/10 hover:border-[#7A5200]/40 hover:bg-amber-50/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1B303C]/30 motion-reduce:transition-none"
      >
