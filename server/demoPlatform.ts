    ...
    questionReporting: [
      {
        ...
        question: "Which verification step must happen before the specialist changes account details?",
        missRate: 42,
        peerMissRate: 26,
        peerPercentile: 18,
        firstPassSuccess: 48,
        ...
        trend: "Miss rate climbed 7 points week over week after a policy wording change.",
        alert: "high",
        coachingAction: "Reinforce identity-confirmation language and audit the first 30 seconds of the interaction.",
      },
      {
        id: "question-report-closing-control",
        module: "Workflow verification essentials",
        skillDomain: "Closing control",
        question: "What is the cleanest closing move after the resolution is confirmed?",
        missRate: 34,
        peerMissRate: 22,
        peerPercentile: 31,
        firstPassSuccess: 57,
        ...
        trend: "Performance improved slightly after manager side-by-side reviews, but misses still cluster in the movable-middle cohort.",
        alert: "medium",
        coachingAction: "Coach transition discipline so agents summarize the fix before offering the final confirmation.",
      },
      {
    ...
    repeatAssignmentReporting: [
      {
        ...
        assignmentCount: 3,
        completionRate: "100%",
        behaviorChange: "QA improvement stalled after the second assignment and only resumed once weekly coaching notes became more specific.",
        recommendedEscalation: "Escalate from module resend to live call review plus manager side-by-side coaching.",
      },
      {
