...
const journeys: LearningJourney[] = [
  {
    ...
    role: "learner",
    title: "Service Foundations: Communication, Empathy, and Call Confidence",
    progress: 71,
    competencyGap: "Empathy language and call control consistency",
    modules: [
      { id: "mod-sf-1", title: "Active listening in high-friction interactions", format: "Microlearning", durationMinutes: 8, skillFocus: "Listening precision", completionRate: 88 },
      { id: "mod-sf-2", title: "Confident reassurance without overpromising", format: "Playbook", durationMinutes: 11, skillFocus: "Language confidence", completionRate: 77 },
      { id: "mod-sf-3", title: "De-escalation and professional recovery", format: "Scenario", durationMinutes: 10, skillFocus: "Service recovery", completionRate: 69 },
      { id: "mod-sf-4", title: "High-scoring closings and next-step confirmation", format: "Checklist", durationMinutes: 6, skillFocus: "Call closure discipline", completionRate: 74 },
    ],
  },
  {
    ...
    tenantId: "atlas-operations",
    role: "manager",
    title: "Workflow Precision and QA-Driven Coaching",
    progress: 83,
    competencyGap: "Coaching consistency on workflow accuracy and documentation",
    modules: [
      { id: "mod-wp-1", title: "Verification and workflow accuracy standards", format: "Playbook", durationMinutes: 9, skillFocus: "Process discipline", completionRate: 91 },
      ...
      { id: "mod-wp-3", title: "Calibration and fair score interpretation", format: "Checklist", durationMinutes: 6, skillFocus: "Evaluation rigor", completionRate: 82 },
    ],
  },
  {
    ...
    tenantId: "atlas-operations",
    role: "coach",
    title: "Coach Supervision: Weekly Coaching and Skill Transfer",
    progress: 77,
    ...
    modules: [
      ...
      { id: "mod-sf-1", title: "Active listening in high-friction interactions", format: "Microlearning", durationMinutes: 6, skillFocus: "Active listening", completionRate: 84 },
    ],
  },
  {
    ...
    tenantId: "atlas-operations",
    role: "executive",
    title: "Data-Led Leadership and Readiness Governance",
    progress: 68,
    competencyGap: "Intervention-to-outcome visibility",
    modules: [
      { id: "mod-dl-1", title: "Reading KPI relationships, not isolated scores", format: "Playbook", durationMinutes: 10, skillFocus: "KPI literacy", completionRate: 72 },
      { id: "mod-dl-2", title: "From signal to root cause to action", format: "Microlearning", durationMinutes: 8, skillFocus: "Root-cause discipline", completionRate: 69 },
      { id: "mod-dl-3", title: "Executive readiness and ROI review cadence", format: "Checklist", durationMinutes: 7, skillFocus: "Governance rhythm", completionRate: 64 },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      { id: "mod-sf-3", title: "De-escalation and professional recovery", format: "Scenario", durationMinutes: 8, skillFocus: "Recovery coaching", completionRate: 82 },
  ...
  },
  {
    ...
    tenantId: "lighthouse-finance",
    role: "manager",
    title: "Performance Leadership: Calibration, Coaching, and Accountability",
    progress: 79,
    competencyGap: "Performance segmentation without bias",
    modules: [
      { id: "mod-lfp-1", title: "High, emerging, and at-risk performance archetypes", format: "Playbook", durationMinutes: 9, skillFocus: "Pattern recognition", completionRate: 81 },
      ...
      { id: "mod-lfp-3", title: "Building improvement plans with measurable checkpoints", format: "Checklist", durationMinutes: 8, skillFocus: "Documentation rigor", completionRate: 80 },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      { id: "mod-sf-2", title: "Confident reassurance without overpromising", format: "Microlearning", durationMinutes: 6, skillFocus: "Reassurance coaching", completionRate: 80 },
      { id: "preview-performance-module", title: "High, emerging, and at-risk performance archetypes", format: "Playbook", durationMinutes: 9, skillFocus: "Pattern recognition", completionRate: 78 },
    ],
  },
  {
    ...
    tenantId: "horizon-commerce",
    role: "manager",
    title: "Engagement Systems and Recognition Design",
    progress: 76,
